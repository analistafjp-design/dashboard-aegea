...
(function (window) {
  ...
  App._carregarGeradorPdf = function () {
    ...
    App._promessaGeradorPdf = carregarScript("/static/js/html2canvas.min.js?v=1.15.0")
      .then(() => carregarScript("/static/js/jspdf.umd.min.js?v=1.15.0"))
      .then(() => carregarScript("/static/js/html2pdf.min.js?v=1.15.0"))
