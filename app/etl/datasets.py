...
IMPLANTACAO = Dataset(
    ...
    campos=(
        ...
        Campo("faturado", "booleano",
              ...
              peso=2),
        Campo("data_inicio_sla", "data",
              "Início da SLA — data de início do prazo de execução",
              aliases=("inicio sla", "inicio da sla", "data inicio sla", "início da sla")),
        Campo("data_fim_sla", "data",
              "Fim da SLA — data limite para execução",
              aliases=("fim sla", "fim da sla", "data fim sla", "data limite", "prazo")),
        CAMPO_QUANTIDADE,
        CAMPO_VALOR,
    ),
