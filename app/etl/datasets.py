...
IMPLANTACAO = Dataset(
    ...
    campos=(
        ...
        CAMPO_FRENTE,
        CAMPO_MATRICULA,
        Campo("protocolo", "texto",
              "Cód. Protocolo Origem — identifica a implantação na medida do PBIX",
              aliases=("cod protocolo origem", "codigo protocolo origem",
                       "cod. protocolo origem", "protocolo origem", "protocolo",
                       "cod protocolo", "codigo do protocolo")),
        ...
        Campo("faturado", "booleano",
              ...
              peso=2),
        Campo("inicio_sla", "data_hora", "Início da SLA — data de início do prazo de execução",
              aliases=("inicio sla", "inicio da sla", "data inicio sla", "início da sla",
                       "data de inicio", "data inicio", "comeco sla")),
        Campo("fim_sla", "data_hora", "Fim da SLA — data limite para execução",
              aliases=("fim sla", "fim do sla", "data fim sla", "data limite", "prazo",
                       "data de fim", "vencimento sla", "prazo sla", "data vencimento")),
        CAMPO_QUANTIDADE,
        CAMPO_VALOR,
    ),
