    ...
    if dataset.nome == "vendas":
        return {
            **comum,
            ...
            "conta_comercial": bool(_valor(linha, "conta_comercial", False)),
            "conta_vcg": bool(_valor(linha, "conta_vcg", False)),
            "tipo_atividade": _valor(linha, "tipo_atividade"),
            "codigo_descricao": _valor(linha, "codigo_descricao"),
            "matricula": _valor(linha, "matricula"),
            "quantidade": float(_valor(linha, "quantidade", 1.0)),
            "valor": _valor(linha, "valor"),
        }
    if dataset.nome == "implantacao":
        return {
            **comum,
            ...
            "tipo": _valor(linha, "tipo", "NAO_CLASSIFICADO"),
            "matricula": _valor(linha, "matricula"),
            "protocolo": _valor(linha, "protocolo"),
